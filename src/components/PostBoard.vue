<template>
  <div
    class="rounded-md my-3 shadow-md w-[380px] sm:w-[600px] md:w-[600px] bg-gray-50 text-gray-800"
  >
    <!-- Poster -->
    <div class="flex items-center justify-between p-3">
      ...
      <div class="flex items-center space-x-2">
        ...
        />
        <div class="-space-y-1">
          <h2 class="text-sm font-semibold leadi">leroy_jenkins72</h2>
          <span class="inline-block text-xs leadi text-gray-600">Somewhere</span>
        </div>
      </div>
      <!-- More button -->
    ...
    <img
      ...
      alt="RandomImage"
      class="object-container w-full h-96 bg-gray-500"
    />
    <div class="p-3">
      ...
      <div class="flex flex-wrap items-center pt-3 pb-1">
        <div class="flex items-center space-x-2">
          <div class="flex -space-x-1">
            <img
              alt=""
              class="w-5 h-5 border rounded-full bg-gray-500 border-gray-100"
          ...
          <span class="text-sm"
            >Liked by <span class="font-semibold">Mamba UI </span>and
      ...
      <div class="space-y-3">
        <p class="text-sm">
          <span class="text-base font-semibold">leroy_jenkins72</span> Nemo ea quasi debitis
          impedit!
        </p>
        <input
          type="text"
          placeholder="Add a comment..."
          class="w-full py-0.5 bg-transparent border-none rounded text-sm pl-0 text-gray-800"
        />
      </div>
    </div>
  </div>
  ...
  <!-- <div class="post">
    <div class="avatar-wrapper">
      <img :src="`https://avatars.dicebear.com/api/open-peeps/${seed}.svg`" alt="" class="avatar" />
    </div>

    <div class="post-content ml-12 pr-12">
      <p class="post-owner">
        {{ name }}

    ...
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
      ...
      >
        <div class="max-w-xl lg:max-w-3xl">
          ...
          <vee-form @submit="signInWithEmail" class="mt-5 grid grid-cols-6 gap-6">
            <!-- Email field -->
            ...
            <div class="col-span-6">
              ...
              <div class="relative flex items-center justify-center">
                ...
                <div class="absolute right-0 mt-2 mr-3 cursor-pointer">
                  ...
                  <div @click="show = true" v-if="show === false">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div v-else class="col-span-6 sm:flex sm:items-center sm:gap-4">
              ...
              <p class="mt-4 text-sm text-gray-500 sm:mt-0">
                ...
                <router-link :to="{ name: 'register' }" class="text-gray-700 underline"
